...
const VideoEditor = () => {
  ...
  // Update VideoEditor.jsx to handle animation styles in JSON
    ...
    setJsonData({
      canvasItems: items.map(item => ({
        ...
        styles: {
          ...
          highlight: item.styles.highlight || false,
          stroke: item.styles.stroke || false,
          fade: item.styles.fade || false,
          zoom: item.styles.zoom || false,
          slide: item.styles.slide || false
        }
      }))
    });
  };
