...
const DraggableItem = ({ type, text }) => {
  const [{ isDragging }, drag] = useDrag(() => ({
    type: type === 'heading' || type === 'paragraph' ? 'TEXT_ITEM' :
      type === 'fade' || type === 'zoom' || type === 'slide' ? 'ANIMATION' : 'STYLE',
    item: { type, text },
    collect: (monitor) => ({
      ...
      <Paper elevation={3} sx={{
        ...
        <Box sx={{ flexGrow: 1, p: 1 }}>
          ...
          <TabPanel value={value} index={1}>
            ...
            <DraggableItem type="strikeThrough" text="Strike Through" />
            <DraggableItem type="underline" text="Underline" />
